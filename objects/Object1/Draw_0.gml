...
draw_set_colour(c_white);
draw_text_transformed(32, 32 + 40 + string_height("The quick brown fox\njumped over me") * self.font_scale, "The quick brown fox\njumped over me", self.font_scale, self.font_scale, 0);

if (keyboard_check(vk_up)) {
    self.font_scale = min(8, self.font_scale + 0.1);
}
